# -*- coding: utf-8 -*-
"""
Created on Sat Apr 30 13:07:50 2022
...
# Load gambar
input_path = (r'D:/SKRIPSI/Program/Test(2)/Canny/input/')
# save gambar
output_path = (r'D:/SKRIPSI/Program/Test(2)/Canny/output/')
...
#Penerapan filter gaussian blur
def GaussianBlur(image):
    image = cv2.GaussianBlur(image, (3, 3), 0)
    return image

# Penerapan Filter Sobel
...
# Penipisan garis tepi dengan NMS
...
# Transformasi piksel lemah menjadi piksel kuat dengan Double Thershold Hysteresis
